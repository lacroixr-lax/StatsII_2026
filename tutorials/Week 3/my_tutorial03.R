...
# when hessian is equal to true, it tries to understand the curvature - if you have a bigger curvature then you
# there are more values that it could be - telling the optum function to calculate the standard errors
...
# new set of output values, but same input and beta coefficient
...
norm_likelihood2 <- function(outcome, input, parameter) {
  ...
  # density normal function to carry out likelihood score just like before
