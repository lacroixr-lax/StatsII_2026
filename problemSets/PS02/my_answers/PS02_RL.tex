...
\noindent\textbf{Global null hypothesis, p-value, results discussion, and conclusion.}
	...
	\noindent The additive model that was run above can be tested against the null model to determine whether or not the variables, and specifically their different levels, are significant in predicting the likelihood of an individual supporting a policy. A likelihood ratio test will be utlilized to test the two models against one another.
	...
	\noindent In \autoref{tab:Table1}, it can be seen that the coefficients for 
